  ...
  return (
    <div className="space-y-6">
      ...
      {message && (
        ...
        >
          {status === 'success' ? <CheckCircle2 className="w-4 h-4 flex-shrink-0" aria-hidden="true" /> :
           status === 'error' ? <AlertCircle className="w-4 h-4 flex-shrink-0" aria-hidden="true" /> : null}
          {message}
        </div>
      )}
    </div>
